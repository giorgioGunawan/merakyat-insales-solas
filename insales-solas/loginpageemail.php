...
<html lang="en" dir="ltr">
  ...
  <div style="background-color: #3B64B1;
   ...
   <ul>
    ...
    <li><a style="font-family:verdana;" class = "active" href="loginpageemail.php">Contact Email</a></li>
  ...
  <div align="center" =>
    ...
    <h2 margin-top=500px style="font-family:verdana;" align = center>Welcome to Contact Email</h2>
...
<?php
  	...
  	if($val == "123")
  	{
  		...
  		//exit(header("Location:www.fantastic4.dx.am/main.html"));
                ?><script> location.replace("contactemailpage.php"); </script><?php
  	} elseif ($val != "123") {
